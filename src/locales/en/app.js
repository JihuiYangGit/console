...
export default {
  ...
  APP_TEMPLATE_DESCRIPTION:
    'i9000 provides lifecycle management of application template. You can upload or create new application template and test it quickly. In addition, you can publish your application template to App Store so that other users can purchase and deploy it.',

  DEVELOP_APP_TITLE: 'How to Develop Application Template',

  DEVELOP_APP_DESC:
    'You can upload Helm Chart or use the resource orchestration tool provided by i9000 to develop application templates.',

  HOW_PUBLISH_APP_TITLE: 'How to publish applications to App Store',

  HOW_PUBLISH_APP_DESC:
    'i9000 currently supports uploading Helm Charts through Application Templates within Workspace, from where you can submit your template for review. Once approved then you can publish the template to App Store.',
  ...
  APP_TEMPLATES_DESC:
    'i9000 provides application full lifecycle management. You can upload or create new application templates and test them quickly. In addition, you can publish your application to App Store so that other users deploy it in one-click wat.',
  ...
  RESOURCE_TOOL_DESCRIPTION:
    'i9000 provides a visual resource orchestration tool that allows you to' +
