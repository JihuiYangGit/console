...
export default {
  ...
  APPLICATION_TYPE_DESC:
    'i9000 supports application deployments (based on Helm) from the app store, as well as Application CRD.',
  ...
  FROM_APP_STORE_DESC:
    'From the official app store of i9000, providing high-quality applications and easy deployment',
  ...
  APP_TEMPLATES_MODAL_DESC:
    'The application template comes from the workspace and the third-party helm application templates. It supports one click deployment and can be visualized in i9000 to show and provide deployment and management functions',

  TIP_APP_TYPE:
    'i9000 supports application deployment (based on Helm) from app stores and app repositories, as well as home-made applications (Application CRD).',
  TIP_APP_GOVERNANCE:
    'Using App Governance requires creating a homebrew app and turning on service governance for each service',
  APP_REPOS_DESC:
    'The application repository comes from a third-party Helm Chart Repo, which visually exposes and provides deployment and management capabilities in i9000, allowing users to quickly deploy applications one-click based on templates in the application repository.',
