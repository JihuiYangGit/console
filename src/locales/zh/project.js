...
export default {
  ...
  PROJECT_CREATE_DESC:
    'i9000 中的项目对应的是 Kubernetes 的 namespace，是对一组资源和对象的抽象集合，常用来将系统内部的对象划分为不同的项目组或用户组。',
  ...
  'Assign Workspace': '分配组织空间',
  'Target Workspace': '目标组织空间',
  'Choose a workspace': '选择一个组织空间',
  'Not Assigned': '未分配',
  ...
  PROJECT_TYPES_PROJECT_DESC:
    'i9000 中的项目对应的是 Kubernetes 的 namespace，是对一组资源和对象的抽象集合，可以根据不同的业务部门或者产品项目进行资源分组。',
  PROJECT_TYPES_DEVOPS_TITLE: '创建一个 DevOps 工程',
  PROJECT_TYPES_DEVOPS_DESC: '持续、自动地构建/测试软件项目。',

  PROJECT_ASSIGN_DESC: '项目一旦被分配到组织空间后将不允许修改组织空间',
  ...
  HOW_TO_INVITE_MEMBER_A:
    '项目管理员或者拥有成员邀请权限的用户可以邀请当前组织空间内的成员加入项目',
