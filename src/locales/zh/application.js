...
export default {
  ...
  'Choose existing services or create new service components to build an app':
    '选择已有服务或者新建服务组件来构建应用',
  'Deploy applications with one-click application templates provided by i9000':
    '通过 i9000 提供的应用模板一键部署应用',
  ...
  APPLICATION_TYPE_DESC:
    'i9000 支持来自于应用商店和应用仓库的应用部署(基于 Helm)，同样也支持自制应用 (Application CRD)。',
  ...
  FROM_APP_STORE_DESC:
    '来自 i9000 官方应用商店，提供高质量应用和简易的部署方式',
  FROM_APP_TEMPLATES_DESC:
    '来自于组织空间的自制应用模板以及应用仓库中添加的第三方Helm 应用模板',
  COMPOSING_APP_DESC: '通过资源编排的方式发布服务构建应用(支持应用治理功能)',
  APP_TEMPLATES_MODAL_DESC:
    '应用模板来自于组织空间和第三方的Helm应用模板，支持一键部署并可通过可视化的方式在 i9000 中展示并提供部署及管理的功能',
  APP_REPOS_DESC:
    '应用仓库来自于第三方的 Helm Chart Repo，通过可视化的方式在 i9000 中展示并提供部署及管理功能，用户可以基于应用仓库中的模板快速地一键部署应用。',
  SEARCH_TIPS: '您可以根据相关条件进行过滤',

  'From workspace': '来自组织空间',
}
