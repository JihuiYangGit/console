...
class Header extends React.Component {
  ...
  renderDocumentList() {
    return (
      <Menu onClick={this.handleDocumentLinkClick} data-test="header-docs">
        <Menu.MenuItem key={globals.config.documents.url} disabled="true"> 
          <Icon name="hammer" /> {t("User's Manual")}
        </Menu.MenuItem>
        <Menu.MenuItem key={globals.config.documents.api} disabled="true">
  ...
  render() {
    ...
    const logo = globals.config.logo || '/assets/logo_tr.svg'
      ...
      >
        <Link to="/">
          <img
            ...
            src={isAppsPage() ? `/assets/login-logo_tr.svg` : logo}
            alt=""
          />
        </Link>
